...
function love.load()
  ...
  local linkData = EntityDataClass:new("Link", 12, 5, false)
  local moblinData = EntityDataClass:new("Moblin", 4, 4, false)
  local octorokData = EntityDataClass:new("Octorok", 3, 2, false)
  local likeLikeData = EntityDataClass:new("Like Like", 2, 1, false)
  local gibdoData = EntityDataClass:new("Gibdo", 5, 3, false)
  local keeseData = EntityDataClass:new("Keese", 1, 6, true)
